...
:=
  ...
  | .un _ _, .prod _ _ => s!"{path}: un vs pair"
  ...
  | .some _, .prod _ _ => s!"{path}: some vs pair"
  ...
  | .arbUn _, .prod _ _ => s!"{path}: arbUn vs pair"
  ...
  | .const _ _, .prod _ _ => s!"{path}: const vs pair"
  ...
  | .var _, .prod _ _ => s!"{path}: var vs pair"
  ...
  | .null, .prod _ _ => s!"{path}: null vs pair"
  ...
  | .prod _ _, .un _ _ => s!"{path}: pair vs un"
  | .prod _ _, .some _ => s!"{path}: pair vs some"
  | .prod _ _, .arbUn _ => s!"{path}: pair vs arbUn"
  | .prod _ _, .const _ _ => s!"{path}: pair vs const"
  | .prod _ _, .var _ => s!"{path}: pair vs var"
  | .prod _ _, .null => s!"{path}: pair vs null"
  | .prod _ _, .ir _ _ => s!"{path}: pair vs ir"
  | .prod _ _, .full _ => s!"{path}: pair vs full"
  | .prod _ _, .compl _ => s!"{path}: pair vs compl"
  | .prod _ _, .arbIr _ => s!"{path}: pair vs arbIr"
  ...
  | .ir _ _, .prod _ _ => s!"{path}: ir vs pair"
  ...
  | .full _, .prod _ _ => s!"{path}: full vs pair"
  ...
  | .compl _, .prod _ _ => s!"{path}: compl vs pair"
  ...
  | .arbIr _, .prod _ _ => s!"{path}: arbIr vs pair"
