...
variable {b0 b1 c0 c1 o0 o1: Valuation Pair}
...
namespace SingleLaneExpr
  ...
  def intp2_mono_std_prod
    ...
    (leL: intp2 l0 fv0 b0 c0 o0 ≤ intp2 l1 fv1 b1 c1 o1)
    (leR: intp2 r0 fv0 b0 c0 o0 ≤ intp2 r1 fv1 b1 c1 o1)
  :
    intp2 (prod l0 r0) fv0 b0 c0 o0 ⊆ intp2 (prod l1 r1) fv1 b1 c1 o1
  :=
    fun
    | .pair _ _, isDef =>
  ...
  def eq_intp2_prod_of_eq
    (eqL: intp2 l0 fv0 b0 c0 o0 = intp2 l1 fv1 b1 c1 o1)
    (eqR: intp2 r0 fv0 b0 c0 o0 = intp2 r1 fv1 b1 c1 o1)
  :
    intp2 (prod l0 r0) fv0 b0 c0 o0 = intp2 (prod l1 r1) fv1 b1 c1 o1
  :=
    le_antisymm
  ...
  def intp2_mono_std_un
    ...
    (leR: intp2 r0 fv0 b0 c0 o0 ≤ intp2 r1 fv1 b1 c1 o1)
  :
    intp2 (un l0 r0) fv0 b0 c0 o0 ⊆ intp2 (un l1 r1) fv1 b1 c1 o1
  :=
    fun _ ins =>
      (inUnElim ins).elim
  ...
  def intp2_mono_std_ir
    ...
    (leR: intp2 r0 fv0 b0 c0 o0 ≤ intp2 r1 fv1 b1 c1 o1)
  :
    intp2 (ir l0 r0) fv0 b0 c0 o0 ⊆ intp2 (ir l1 r1) fv1 b1 c1 o1
  :=
    fun _ ins =>
  ...
  def intp2_mono_std_some
    (le: intp2 e0 fv0 b0 c0 o0 ≤ intp2 e1 fv1 b1 c1 o1)
  :
    intp2 (some e0) fv0 b0 c0 o0 ⊆ intp2 (some e1) fv1 b1 c1 o1
  :=
    fun _ ins =>
  ...
  def eq_intp2_some_of_eq
    (eq: intp2 e0 fv0 b0 c0 o0 = intp2 e1 fv1 b1 c1 o1)
  :
    intp2 (some e0) fv0 b0 c0 o0 = intp2 (some e1) fv1 b1 c1 o1
  :=
    le_antisymm
  ...
  def intp2_mono_std_full
    (le: intp2 e0 fv0 b0 c0 o0 ≤ intp2 e1 fv1 b1 c1 o1)
  :
    intp2 (full e0) fv0 b0 c0 o0 ⊆ intp2 (full e1) fv1 b1 c1 o1
  :=
    fun _ ins =>
  ...
  def intp2_mono_std_compl
    (le:
      Set.Subset
        (e1.intp2 fv1 c1 b1 o1)
        (e0.intp2 fv0 c0 b0 o0))
  :
    Set.Subset
      ((compl e0).intp2 fv0 b0 c0 o0)
      ((compl e1).intp2 fv1 b1 c1 o1)
  :=
    fun _ ins =>
  ...
  :
    intp2 (.compl (.compl expr)) fv b c o = intp2 expr fv b c o
  :=
  ...
  def intp2_mono_std_arbIr
    {fv0 fv1: List Pair}
    {b0 c0 b1 c1 o0 o1: Valuation Pair}
    (le:
      ∀ pB,
      Set.Subset
        (e0.intp2 (pB :: fv0) b0 c0 o0)
        (e1.intp2 (pB :: fv1) b1 c1 o1))
  :
    Set.Subset
      ((arbIr e0).intp2 fv0 b0 c0 o0)
      ((arbIr e1).intp2 fv1 b1 c1 o1)
  :=
...
namespace BasicExpr
  ...
  def triIntp2_mono_std_prod
    (leL: triIntp2 l0 fv0 b0 c0 o0 ≤ triIntp2 l1 fv1 b1 c1 o1)
    (leR: triIntp2 r0 fv0 b0 c0 o0 ≤ triIntp2 r1 fv1 b1 c1 o1)
  :
    triIntp2 (prod l0 r0) fv0 b0 c0 o0 ≤ triIntp2 (prod l1 r1) fv1 b1 c1 o1
  := {
  ...
  def eq_triIntp2_prod_of_eq
    (eqL: triIntp2 l0 fv0 b0 c0 o0 = triIntp2 l1 fv1 b1 c1 o1)
    (eqR: triIntp2 r0 fv0 b0 c0 o0 = triIntp2 r1 fv1 b1 c1 o1)
  :
    triIntp2 (prod l0 r0) fv0 b0 c0 o0 = triIntp2 (prod l1 r1) fv1 b1 c1 o1
  :=
    Set3.eq
  ...
  def triIntp2_mono_std_un
    ...
    (leR: triIntp2 r0 fv0 b0 c0 o0 ≤ triIntp2 r1 fv1 b1 c1 o1)
  :
    triIntp2 (un l0 r0) fv0 b0 c0 o0 ≤ triIntp2 (un l1 r1) fv1 b1 c1 o1
  := {
  ...
  def triIntp2_mono_std_ir
    ...
    (leR: triIntp2 r0 fv0 b0 c0 o0 ≤ triIntp2 r1 fv1 b1 c1 o1)
  :
    triIntp2 (ir l0 r0) fv0 b0 c0 o0 ≤ triIntp2 (ir l1 r1) fv1 b1 c1 o1
  := {
  ...
  def triIntp2_mono_std_some
    (le: triIntp2 e0 fv0 b0 c0 o0 ≤ triIntp2 e1 fv1 b1 c1 o1)
  :
    triIntp2 (some e0) fv0 b0 c0 o0 ≤ triIntp2 (some e1) fv1 b1 c1 o1
  := {
  ...
  def eq_triIntp2_some_of_eq
    (eq: triIntp2 e0 fv0 b0 c0 o0 = triIntp2 e1 fv1 b1 c1 o1)
  :
    triIntp2 (some e0) fv0 b0 c0 o0 = triIntp2 (some e1) fv1 b1 c1 o1
  :=
    Set3.eq
  ...
  def triIntp2_mono_std_full
    (le: triIntp2 e0 fv0 b0 c0 o0 ≤ triIntp2 e1 fv1 b1 c1 o1)
  :
    triIntp2 (full e0) fv0 b0 c0 o0 ≤ triIntp2 (full e1) fv1 b1 c1 o1
  := {
  ...
  def triIntp2_mono_std_compl
    (le: triIntp2 e1 fv1 c1 b1 o1 ≤ triIntp2 e0 fv0 c0 b0 o0)
  :
    triIntp2 (compl e0) fv0 b0 c0 o0 ≤ triIntp2 (compl e1) fv1 b1 c1 o1
  := {
  ...
  def eq_triIntp2_compl_of_eq
    (eq: triIntp2 e0 fv0 c0 b0 o0 = triIntp2 e1 fv1 c1 b1 o1)
  :
    triIntp2 (compl e0) fv0 b0 c0 o0 = triIntp2 (compl e1) fv1 b1 c1 o1
  :=
    Set3.eq
  ...
  def triIntp2_mono_std_arbIr
    (le:
      ∀ pB,
      triIntp2 e0 (pB :: fv0) b0 c0 o0 ≤ triIntp2 e1 (pB :: fv1) b1 c1 o1)
  :
    triIntp2 (arbIr e0) fv0 b0 c0 o0 ≤ triIntp2 (arbIr e1) fv1 b1 c1 o1
  := {
