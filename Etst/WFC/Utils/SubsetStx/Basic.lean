...
namespace DefList.SubsetStx
  ...
  :=
    (nullPairComplPair (a := none)).unElim
      (irCtxR subUnL)
      (unElimCont
        (irCtxR ((pairMonoSubL subAny subId).unR))
        (unElimCont
          (irCtxR ((pairMonoSubR subAny subId).unR))
