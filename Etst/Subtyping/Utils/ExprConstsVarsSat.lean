/-
  Defines instances for deciding whether all constants or free
  variables in an expression satisfy a given predicate.
-/
...
namespace Expr
  ...
  abbrev ConstsLt (expr: Expr E) (bound: Nat): Prop :=
